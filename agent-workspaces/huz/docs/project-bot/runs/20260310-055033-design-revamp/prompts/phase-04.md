...
## Goal
Update blueprint and design docs so future runs know how the module changed.
...
- Update the atlas docs for the touched module, components, routes, and shared dependencies.
- Update the design context doc with the guides and reference examples used.
- Append a final implementation summary and verification notes.
...
`node /Users/macbook/.codex/skills/project-autopilot-manager/scripts/project_orchestrate.mjs complete --run /Users/macbook/Desktop/Codex-Project-Bot-GUI/agent-workspaces/huz/docs/project-bot/runs/20260310-055033-design-revamp --phase 4`
