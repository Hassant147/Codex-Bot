...
## Goal
Read the design guides, atlas docs, and requested reference modules before making UI decisions.
...
- Read all relevant design guides and any user-provided reference pages or modules.
- Map the target scope, existing component structure, and dependencies using the atlas docs.
- Record the non-negotiable UX constraints and intended visual direction.
...
`node /Users/macbook/.codex/skills/project-autopilot-manager/scripts/project_orchestrate.mjs complete --run /Users/macbook/Desktop/Codex-Project-Bot-GUI/agent-workspaces/huz/docs/project-bot/runs/20260310-055033-design-revamp --phase 0`
