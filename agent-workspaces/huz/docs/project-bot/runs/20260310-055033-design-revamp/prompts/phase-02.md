...
## Goal
Apply the new frontend design across the requested page or module while keeping behavior intact.
...
- Implement the new UI using the design guides and the referenced module/page examples.
- Keep routes, data flow, and behavior aligned unless the request explicitly calls for functional changes.
- Extract reusable shared UI only when it improves consistency across the target module.
...
`node /Users/macbook/.codex/skills/project-autopilot-manager/scripts/project_orchestrate.mjs complete --run /Users/macbook/Desktop/Codex-Project-Bot-GUI/agent-workspaces/huz/docs/project-bot/runs/20260310-055033-design-revamp --phase 2`
