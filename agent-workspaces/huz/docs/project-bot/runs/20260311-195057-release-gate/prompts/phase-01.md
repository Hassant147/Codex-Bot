...
## Goal
Execute the release checks and fix only the blockers that are safe and within scope.
...
- Run the defined build, test, lint, smoke, and report commands.
- Fix safe blockers found during the gate if the request allows implementation.
- Avoid opportunistic unrelated refactors while clearing the gate.
...
`node /Users/macbook/.codex/skills/project-autopilot-manager/scripts/project_orchestrate.mjs complete --run /Users/macbook/Desktop/Codex-Project-Bot-GUI/agent-workspaces/huz/docs/project-bot/runs/20260311-195057-release-gate --phase 1`
