...
## Goal
Collect the exact build, test, lint, smoke, and documentation checks needed for the requested release gate.
...
- Read the atlas docs, change map, backlog, and project commands relevant to the release target.
- Define the release gate checklist for the scoped project or module.
- Identify known blockers or high-risk open items before execution.
...
`node /Users/macbook/.codex/skills/project-autopilot-manager/scripts/project_orchestrate.mjs complete --run /Users/macbook/Desktop/Codex-Project-Bot-GUI/agent-workspaces/huz/docs/project-bot/runs/20260311-195057-release-gate --phase 0`
